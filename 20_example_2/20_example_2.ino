...
void loop()
{
  ...
  filtered = ir_sensor_filtered(15, 0.5, 0); // Replace n with your desired value
...
//  return 749 + -2.7 * a_value  + 2.43E-03 * a_value * a_value;
//  return 1478 - 8.77 * a_value + 0.0181 * pow(a_value, 2) -
//           1.26E-05 * pow(a_value, 3);
      return 1294 + -7.47 * a_value + 0.0152 * pow(a_value, 2) + -1.05E-05 *  pow(a_value, 3);
//  return 1329 - 7.7 * a_value + 0.0157 * pow(a_value, 2);1329 - 7.7 * a_value + 0.0157 * pow(a_value, 2);
}
