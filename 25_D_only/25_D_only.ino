...
#define _DUTY_MIN 1100 // 1000// Event interval parameters
#define _INTERVAL_DIST    20 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   20 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  100 // serial interval (unit: ms)
...
#define _SERVO_SPEED       1080   // servo speed #define _SERVO_ANGLE_DIFF  276   // Replace with |D - E| degree 
...
#define _KD 7.333  // derivative gain
